    ...
    return (
        <div className="overview-container">
            <div className="overview-row">
                <div className="overview-item overview-left">
                    <h1 className="overview-title">ภาพรวมโรงแรม</h1>
                    <p className="overview-text">
                        นอกจากที่พักจะได้รับการรับรองมาตรฐาน SHA ที่พักยังมีบริการ Wi-Fi ฟรี ในทุกห้องพัก และที่จอดรถฟรี
                        ที่พักตั้งอยู่ในย่านตัวเมืองหนองคาย จึงอยู่ใกล้กับที่เที่ยวมากมาย และสะดวกต่อการเดินทางไปสถานที่ต่างๆ
                ...
                <div className="overview-item overview-right">
                    <h1 className="overview-title">บริการเด่น</h1>
            ...
            <div className="overview-row overview-promotion">
                <div className="overview-item">
                    <h1 className="overview-title">โปรโมชั่น</h1>
